...
const GIF_SECTION1_URL = "https://storage.googleapis.com/duotopia-social-media-videos/website/allstudents-tab01.gif";
const GIF_SECTION2_URL = "https://storage.googleapis.com/duotopia-social-media-videos/website/allstudents-tab02.gif";
...
export default function AllStudentsTab() {
  ...
  return (
    <div className="px-1 py-2 md:px-8 md:py-8 space-y-12 w-full">
      <Section
        ...
        gifAlt={t("teacherDashboard.allStudentsTab.gifAlt1")}
        isEn={isEn}
      />
      <Section
        title={t("teacherDashboard.allStudentsTab.section2")}
        gifUrl={GIF_SECTION2_URL}
        gifAlt={t("teacherDashboard.allStudentsTab.gifAlt2")}
        isEn={isEn}
      />
    </div>
  );
